...
public class MainActivity extends AppCompatActivity {
    ...
    String s1[], s2[],s3[];
    int images[] = {R.drawable.sport_pria,R.drawable.jam_tangan,R.drawable.kemeja};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1 = getResources().getStringArray(R.array.Zalora);
        s2 = getResources().getStringArray(R.array.Deskripsi);
        s3 = getResources().getStringArray(R.array.Star);
        ZaloraAdapter appAdapter = new ZaloraAdapter(this, s1, s2, s3, images);
